                ...
                return (
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-sm">
                            <thead className="text-gray-400"><tr><th className="p-2 text-left">Name</th><th className="p-2 text-left">Email</th><th className="p-2 text-left">IP Address</th><th className="p-2 text-left">API Key</th><th className="p-2 text-left">Is Admin</th><th className="p-2 text-left">Custom Expiry</th></tr></thead>
                            <tbody className="divide-y divide-white/10">
                                {users.map(u => (
                                    <tr key={u.id}>
                                        <td className="p-2">{u.name}</td>
                                        <td className="p-2">{u.email}</td>
                                        <td className="p-2 font-mono text-xs">{u.ipAddress || 'N/A'}</td>
