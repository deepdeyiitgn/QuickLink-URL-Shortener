            ...
            case 'signup': {
                ...
                const htmlEmail = `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin:auto; border:1px solid #ddd; padding:20px; text-align:center; background:#f9f9f9;">
                        <img src="https://quick-link-url-shortener.vercel.app/quicklink-logo.jpg" alt="QuickLink Logo" style="width:150px; margin-bottom:20px;" />
